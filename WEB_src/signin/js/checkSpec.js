...
var vm = new Vue({
    ...
    data () {
        ...
        return {
            ...
            count : '1',
            unitPrice:0, //单价
            active_type: sessionStorage.getItem('active_type'), // 商品类型 洗面奶，酒,衣服,足球
            ...
            goods:{
                color:[{
                    img: '/signin/images/1.png',
                    color: '橘色'
                },{
                    img: '/signin/images/product.jpg',
                    color: '橘色'
                },{
                    img: '/signin/images/lose.png',
                    color: '橘色'
                },{
                    img: '/signin/images/lottery.png',
                    color: '橘色'
                },],
                size: ['S','M','L','X','XL','XXL','XXXL'],
                colorIndex: -1,
                sizeIndex: -1,
                product_img: '/signin/images/1.png',
            }
        }
    },
    computed :{
    ...
    methods :{
        checkGoogsSpec(index,classify){
            let that = this
            if(classify == 1){
                that.goods.colorIndex = index;
                that.goods.product_img = that.goods.color[index].img
            }else{
                that.goods.sizeIndex = index
            }
        },
        //检测单价
        checkCount(){
